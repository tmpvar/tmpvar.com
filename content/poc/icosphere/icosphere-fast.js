...
// from: https://github.com/stonkpunk/my-npm-modules/tree/main/icosphere-fast, MIT licensed
export function GenerateIcosphere(subdivisions) {
...
export function mergeVertices(mesh, precision = 6) {
